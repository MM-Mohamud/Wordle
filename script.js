...
function showStartScreen() {
  ...
  // prevent typing before starting
  stopInteraction();
...
function checkWinLose(guess, tiles) {
  if (guess === targetWord) {
    ...
    const filledTiles = guessGrid.querySelectorAll("[data-letter]").length;
    const guessNumber = filledTiles / WORD_LENGTH;

    if (guessNumber === 1) {
      showAlert("You're actually a real fan eh!", 6000);
    } else {
      showAlert("😔", 6000);
      showAlert("Thought you were a true ONCE!", 6000);
    }
